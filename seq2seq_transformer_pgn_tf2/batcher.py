...
def example_generator(vocab, train_x_path, train_y_path, eval_x_path, eval_y_path, test_x_path, max_enc_len,
    ...
    if mode == "eval":
        dataset_train_x = tf.data.TextLineDataset(eval_x_path)
        dataset_train_y = tf.data.TextLineDataset(eval_y_path)
        eval_dataset = tf.data.Dataset.zip((dataset_train_x, dataset_train_y))
...
def batch_generator(generator, vocab, train_x_path, train_y_path, eval_x_path, eval_y_path,
    ...
    dataset = tf.data.Dataset.from_generator(lambda: generator(vocab, train_x_path, train_y_path,
                                                               eval_x_path, eval_y_path,
                                                               test_x_path, max_enc_len,
                                                               max_dec_len, mode, batch_size),
                                             output_types={
                                                 "enc_len": tf.int32,
                                                 "enc_input": tf.int32,
